...
const MAP_LAYOUTS = {
  ...
  '16': {
    ...
    lots: [
      ...
      // Row 7 — 139~144
      { lot:'139', col:27, row:7, cols:1, graves:['1'] },
      { lot:'140', col:28, row:7, cols:4, graves:['1','2','3','4'] },
      { lot:'141', col:32, row:7, cols:4, graves:['1','2','3','4'] },
      { lot:'142', col:36, row:7, cols:4, graves:['1','2','3','4'] },
      { lot:'143', col:40, row:7, cols:4, graves:['1','2','3','4'] },
      { lot:'144', col:44, row:7, cols:4, graves:['1','2','3','4'] },
    ]
  }
};
