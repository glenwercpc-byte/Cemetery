...
const MAP_LAYOUTS = {
  ...
  '16': {
    ...
    lots: [
      ...
      // 메인 행 오른쪽 — 197~206
      { lot:'197', col:24, row:3, cols:4, graves:['145','146','147','148','149','150','151','152','153','154','155','156'] },
      { lot:'198', col:26, row:3, cols:4, graves:['161','162','163','164','165','166','167','168','169','170','171','172'] },
      { lot:'199', col:28, row:3, cols:2, graves:['177','178'] },
      { lot:'200', col:29, row:3, cols:4, graves:['179','180','181','182'] },
      { lot:'201', col:30, row:3, cols:4, graves:['183','184','185','186'] },
      { lot:'202', col:31, row:3, cols:4, graves:['187','188','189','190'] },
      { lot:'203', col:32, row:3, cols:4, graves:['191','192','193','194'] },
      { lot:'204', col:33, row:3, cols:4, graves:['195','196','197','198'] },
      { lot:'205', col:34, row:3, cols:4, graves:['199','200','201','202'] },
      { lot:'206', col:36, row:3, cols:2, graves:['3','4'] },
      // D행 — 170~165 (col 14~27)
